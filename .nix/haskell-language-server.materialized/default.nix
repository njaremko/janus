  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hls-stylish-haskell-plugin".revision = (((hackage."hls-stylish-haskell-plugin")."1.0.1.1").revisions).default;
        ...
        "hls-tactics-plugin".revision = (((hackage."hls-tactics-plugin")."1.6.2.0").revisions).default;
        ...
        "hls-brittany-plugin".revision = (((hackage."hls-brittany-plugin")."1.0.2.1").revisions).default;
